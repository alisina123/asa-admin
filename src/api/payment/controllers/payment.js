...
module.exports = createCoreController('api::payment.payment', ({ strapi }) => ({
  ...
  async paymentSuccess(ctx) {
    try {
      ...
      // ✅ NEW - pointing to your Next.js frontend
      ctx.type = 'html'
ctx.type = 'html'
ctx.body = `<!DOCTYPE html><html><head><title>Payment Successful</title><style>body{font-family:sans-serif;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;background:#f0fdf4;}.box{text-align:center;padding:40px;background:white;border-radius:16px;box-shadow:0 4px 20px rgba(0,0,0,0.1);}h1{color:#16a34a;}p{color:#555;}</style></head><body><div class="box"><h1>✅ Payment Successful!</h1><p>Order #${cartId} confirmed.</p><p>Transaction: ${transaction_id}</p></div></body></html>` 
    } catch (error) {
      console.error('==========================================');
